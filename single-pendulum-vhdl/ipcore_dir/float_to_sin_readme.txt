The following files were generated for 'float_to_sin' in directory
...
C Simulation Generator:
   ...
   * float_to_sin/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * float_to_sin/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * float_to_sin/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * float_to_sin/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_float_to_sin.vhd
...
Deliver Readme:
   ...
   * float_to_sin_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * float_to_sin_flist.txt
