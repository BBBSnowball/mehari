# 
# Project automation script for single-pendulum-vhdl 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source single-pendulum-vhdl.tcl), then you can
...
set myProject "single-pendulum-vhdl"
set myScript "single-pendulum-vhdl.tcl"
...
proc add_source_files {} {
   ...
   project set top "behavior" "test_single_pendulum"
