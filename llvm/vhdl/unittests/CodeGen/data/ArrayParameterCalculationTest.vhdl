...
entity test is
   port ( 
         ...
         a_1_in_data : in  std_logic_vector(63 downto 0);
         a_1_in_valid : in std_logic;
         a_1_in_ready : out std_logic;
...
signal a_1_in_ready_ : std_logic;
...
begin
   a_1_out_data <= 1;
   a_1_out_valid <= '1';
   a_1_in_ready <= a_1_in_ready_;
   t0_data <= t0_data_;
   t0_valid <= t0_valid_;
   t0: fpadd
      port map ( a_data => a_1_in_data,
                 a_ready => a_1_in_ready_,
                 a_valid => a_1_in_valid,
                 b_data => 2,
                 b_valid => '1',
